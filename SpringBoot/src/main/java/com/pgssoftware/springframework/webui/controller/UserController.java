...
public class UserController {
    ...
    public UserLimited findFirstByFirstName(@RequestParam String firstName) {
        return userService.findFirstByFirstName(firstName);
    }
    ...
    public List<AppUserDto> findByLastName(@PathVariable String lastName, Pageable pageable) {
